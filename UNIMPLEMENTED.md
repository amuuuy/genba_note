...
| M-13 | ストアメタデータ未作成 | ドラフト完了（docs/store-metadata-ja.md） | ドラフト: 除外、スクショ: M-04-07/13、レビュー: M-04-12/13 |
...
| 5.4 | 説明文・キーワード作成 | ドラフト完了 | M-04-12/13（docs/store-metadata-ja.md） |
...
| M-04-12/13 | 説明文・キーワード最終レビュー | M-13/MS5 | S | [~] ドラフト完了（docs/store-metadata-ja.md）、最終レビュー残 |
| M-04-13/13 | アプリ名・サブタイトル最終確認 | RELEASE_TODO | S | [~] ドラフト完了（docs/store-metadata-ja.md）、最終確認残 |
...
| M-04/07 ストア申請準備 | 13 | `[Human/Both]` | 0/13（ドラフト2件あり） |
